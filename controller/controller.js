...
export class Controller {
    constructor(view, model, app, gravitySpeed) {
        ...
        this.canvasSize = { width: this.model.app.view.width, height: this.model.app.view.height };
    ...
    run(gravitySpeed, x, y) {
        ...
        this.view.updateHeaderMetrics(this.model.numberOfShapes, this.model.occupiedArea);

        // Remove figure from the screen after click on it
        figure.on('click', (e) => {
            this.model.removeShape(figure);
